    ...
    <>
      ...
      <section className="px-0 py-[72px]">
        <div className="mx-auto w-[min(1160px,calc(100%-40px))]">
          <div className="grid gap-[34px] lg:grid-cols-[1.05fr_0.95fr]">
            <div>
          ...
          <div className="mt-10 mx-auto max-w-[920px] overflow-hidden rounded-[28px] border-2 border-[#244e30] bg-[rgba(255,255,255,0.75)] p-[18px] shadow-[0_24px_60px_rgba(38,52,40,0.08)]">
            <div className="mb-4 text-center">
              <p className="mb-2 text-[0.82rem] font-extrabold uppercase tracking-[0.12em] text-[#5c7e5d]">
                Her finner du oss
              </p>
              <h3 className="text-[1.18rem] font-semibold tracking-[-0.03em] text-[#244e30]">
                Butikken ligger sentralt i Ålesund
              </h3>
              <p className="m-0 leading-7 font-medium text-[#3f6b49]">
                Green Ålesund holder til i Kipervikgata. Kartet under gjør det enklere å finne
                fram til butikken.
              </p>
            </div>

            <div className="overflow-hidden rounded-[20px] border border-[rgba(32,59,43,0.12)]">
              <iframe
                title="Kart over Green Ålesund"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2713.2020476127614!2d6.158171577994765!3d62.47208707628595!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4616db9cc9eae459%3A0x7ee619bd580709d3!2sGreen%20Aalesund!5e1!3m2!1sen!2sno!4v1776803298893!5m2!1sen!2sno"
